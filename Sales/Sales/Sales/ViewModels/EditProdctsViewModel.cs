...
namespace Sales.ViewModels
{
    public class EditProdctsViewModel:BaseViewModel 
    {
        ...
        private async void Save()
        {
            ...
            var response = await this.apiService.Put("http://salesapi.somee.com/", "/api", "/ProductsLuis", this.Product, this.Product.CVE_PRODUCTO_VAR, Settings.TokenType, Settings.AccessToken);
